// Reference : https://embed.plnkr.co/plunk/fZRWnk

export namespace BitcoinScript {
  ...
  const codeops = Object.keys(opcodes).reduce(function(o, k) {
    o[opcodes[k]] = k; return o;
  },{});

  export namespace Bytes {
    export function fromHex(bytes) {
